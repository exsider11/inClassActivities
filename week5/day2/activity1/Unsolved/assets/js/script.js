...
newP.attr("style","font-size:28px");
newP.attr("style","color:light-gray")
newP.addClass("plain")

var newH=$('<h1>');
newH.text("Love Challenges, Be Intrigued by Mistakes, Enjoy Effort, and Keep Learning.");
newH.attr("style","color:cyan");
newH.addClass("fancy");
