...
describe('BlogPost', () => {
  ...
  describe('Instantiate', () => {
    it('should be an instance of BlogPost class', () => {
      ...
      expect(blogpost).toBeInstanceOf(BlogPost); // expect the blogpost created to be an instance of BlogPost class
    });
  });
  ...
  describe('Initialize authorName', () => {
    it('should set authorName properly', () => {
      ...
      expect(blogpost.authorName).toBe(authorName); // expect authorname in BlogPost class to be the same as the instanced blogpost
    });
  });
  ...
  describe('Initialize title', () => {
    it('should set title properly', () => {
      ...
      expect(blogpost.title).toBe(title); // expect title in BlogPost class to be the smae as the instanced blogpost 
    });
  });
  ...
  describe('Initialize text', () => {
    it('should set text properly', () => {
      ...
      expect(blogpost.text).toBe(text); // the desired text should be the same as blogpost.text
    });
  });
  ...
  describe('Initialize createdOn', () => {
    it('should set createdOn properly', () => {
      ...
      expect(blogpost.createdOn).toBe(createdOn); // the blogpost instance should have the createdOn constant as blogpost.createdOn
    });
  });
